...
public class CategoryFragment extends Fragment implements View.OnClickListener {
    ...
    @Override
    public void onClick(View v) { //kita manipulasi fragent yg mau kita tuju
        if (v.getId() == R.id.btn_detail_category){
            ...
            mDetailCategoryFragment.setArguments(mBundle);//knp setArguments? karena di detailcategoryfragement kita nge getArgument. 
            mDetailCategoryFragment.setDescription(description); //description, karena itu yg di setter
